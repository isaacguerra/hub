  ...
  class NotifyParticipationJob < ApplicationJob
    ...
    def perform(participant_id)
      ...
      Apoiador.where.not(id: apoiador_entrou.id).find_each do |apoiador|
        SendWhatsappJob.perform_later(whatsapp: apoiador.whatsapp, mensagem: mensagem)
      end
      ...
      SendWhatsappJob.perform_later(whatsapp: apoiador_entrou.whatsapp, mensagem: msg_confirmacao)
    end
  end
end
